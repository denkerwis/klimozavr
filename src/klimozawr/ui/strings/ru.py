...
_STRINGS: Mapping[str, str] = {
    ...
    "device_editor.label.ip": "IP-адрес",
    ...
    "device_editor.validation_ip_required": "IP-адрес обязателен.",
    ...
    "admin.devices_list_item": "{ip}  |  {name}",
    ...
    "raw.traceroute_start": "трассировка {ip} →",
    "placeholder.na": "—",
    "unit.ms": "мс",
    "unit.day_short": "д",
    "unit.hour_short": "ч",
