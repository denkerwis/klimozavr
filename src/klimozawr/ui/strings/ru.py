...
_STRINGS: Mapping[str, str] = {
    ...
    "device_editor.label.sound_warning": "Звук предупреждения (YELLOW.wav)",
    "device_editor.label.sound_critical": "Звук критичности (RED.wav)",
    ...
    "settings.label.sound_warning_global": "YELLOW.wav (глобальный)",
    "settings.label.sound_critical_global": "RED.wav (глобальный)",
    "settings.label.sound_offline_global": "OFFLINE.wav (глобальный)",
    "settings.sound_down_label": "DOWN.wav",
    "settings.sound_up_label": "UP.wav",
    "settings.sound_warning_label": "YELLOW.wav",
    "settings.sound_critical_label": "RED.wav",
    "settings.sound_offline_label": "OFFLINE.wav",
    ...
    "host_offline.overlay": "НЕТ ИНТЕРНЕТА",
