...
_STRINGS: Mapping[str, str] = {
    ...
    "device_editor.label.sound_unstable": "Звук нестабильности (UNSTABLE.wav)",
    ...
    "settings.label.sound_unstable_global": "UNSTABLE.wav (глобальный)",
    ...
    "settings.sound_unstable_label": "UNSTABLE.wav",
    ...
    "raw.traceroute_error": "Ошибка трассировки: {error}",
    "host_offline.title": "Нет доступа к интернету на устройстве мониторинга",
    "host_offline.subtitle": "Проверка узлов приостановлена",
